...
-----END PUBLIC KEY-----
  ...
  const examplePKCS8PrivateKey44 = `
    -----BEGIN PRIVATE KEY-----
  ...
  const examplePKCS8PrivateKey65 = `
    -----BEGIN PRIVATE KEY-----
  ...
  const examplePKCS8PrivateKey87 = `
    -----BEGIN PRIVATE KEY-----
...
const exampleKeys = {
  SPKIPublicKey: {
    "ML-DSA-44": exampleSPKIPublicKey44,
    "ML-DSA-65": exampleSPKIPublicKey65,
    "ML-DSA-87": exampleSPKIPublicKey87,
  },
  PKCS8PrivateKey: {
    "ML-DSA-44": examplePKCS8PrivateKey44,
    "ML-DSA-65": examplePKCS8PrivateKey65,
    "ML-DSA-87": examplePKCS8PrivateKey87,
  }
};
