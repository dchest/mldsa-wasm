...
#include "poly.h"
#include "polyvec.h"
//#include "randombytes.h" // mldsa-wasm: we provide seeds for randomness
#include <string.h>
#include "sign.h"
#include "symmetric.h"
#include <stdint.h>
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_CLEAN_crypto_sign_keypair_seed
*
...
*              - uint8_t *seed: pointer to input seed (array of PQCLEAN_MLDSA65_CLEAN_CRYPTO_SEEDBYTES bytes)
...
int PQCLEAN_MLDSA65_CLEAN_crypto_sign_keypair_seed(uint8_t *pk, uint8_t *sk, const uint8_t *seed) {
    ...
    // mldsa-wasm: use provided seed instead of calling randombytes.
...
/*************************************************
* Name:        crypto_sign_signature_seed
*
...
*              - uint8_t *randomness: pointer to randomness (of length PQCLEAN_MLDSA65_CLEAN_CRYPTO_RNDBYTES)
*             (Added for mldsa-wasm)
*
* Returns 0 (success) or -1 (context string too long)
**************************************************/
int PQCLEAN_MLDSA65_CLEAN_crypto_sign_signature_ctx_seed(uint8_t *sig,
        size_t *siglen,
        const uint8_t *m,
        size_t mlen,
        const uint8_t *ctx,
    ...
    memcpy(rnd, randomness, RNDBYTES);
...
// Delete functions, not needed for mldsa-wasm:
